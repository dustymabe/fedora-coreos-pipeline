...
def run_cloud_tests(pipecfg, stream, version, cosa_img, s3_stream_dir, basearch, commit) {
    def testruns = [:]
...
def run_fcos_upgrade_tests(pipecfg, stream, version, cosa_img, basearch, commit) {
