...
def run_cloud_tests(pipecfg, stream, version, cosa, basearch, commit) {
    ...
    if (shwrapCapture("cosa meta --arch=${basearch} --build=${version} --get-value amis") != "None" &&
    ...
    if (stream != "rawhide" || (month != Calendar.JUNE && month != Calendar.JULY)) {
        ...
        if (shwrapCapture("cosa meta --arch=${basearch} --build=${version} --get-value images.azure") != "None" &&
    ...
    if (shwrapCapture("cosa meta --arch=${basearch} --build=${version} --get-value gcp") != "None" &&
    ...
    if (shwrapCapture("cosa meta --arch=${basearch} --build=${version} --get-value images.openstack") != "None" &&
